...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_checkAddToCart (self):
        ...
        option_btn.click()
        select_size = self.driver.find_element_by_css_selector('#input-option224 > option:nth-child(2)')
        select_size.click()
        add_product_btn = self.driver.find_element_by_css_selector('# button-cart')
