...
class FirstSeleniumTest(unittest.TestCase):
    ...
    def test_euro_search(self):
        currency = self.driver.find_element_by_css_selector('#form-currency > div > button > i')
        currency.click()
        euro.find_element_by_css_selector('#form-currency > div > ul > li:nth-child(1) > button')
        euro.click()
