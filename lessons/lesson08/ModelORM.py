...
# print(session.query(Book).filter(Book.title == 'book1'))
# print(session.query(Book).filter(Book.title == 'book1').all())
# print(session.query(Book).filter(Book.title == 'book1').first())
# b = session.query(Book).filter(Book.title == 'book1').first()
# b.print()
